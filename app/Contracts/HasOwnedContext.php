 ...
 * - HasOwnedContext ← sólo direct + hierarchical (los que tienen y pueden resolver contexto propio)
 */
interface HasOwnedContext extends HasContext
{
  // Sin métodos adicionales: la interfaz existe como distinción de tipo.
  // HasOwnedContext ──► safe for ->on($model) and ->onAllCurrentInstances(ContextualModelType)
