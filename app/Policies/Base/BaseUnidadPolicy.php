...
/**
 * Policy Base para Unidad - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/UnidadPolicy.php:
 ...
 */
abstract class BaseUnidadPolicy
{
    ...
    public function view(Usuario $user, Unidad $model): bool
    {
    ...
    public function update(Usuario $user, Unidad $model): bool
    {
    ...
    public function delete(Usuario $user, Unidad $model): bool
    {
