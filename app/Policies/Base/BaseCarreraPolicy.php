...
/**
 * Policy Base para Carrera - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/CarreraPolicy.php:
 ...
 */
abstract class BaseCarreraPolicy
{
    ...
    public function view(Usuario $user, Carrera $model): bool
    {
    ...
    public function update(Usuario $user, Carrera $model): bool
    {
    ...
    public function delete(Usuario $user, Carrera $model): bool
    {
