...
/**
 * Policy Base para Curso - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/CursoPolicy.php:
 ...
 */
abstract class BaseCursoPolicy
{
    use HasBasePolicyMethods;

    protected string $resource = 'cursos';
    ...
    public function view(Usuario $user, Curso $model): bool
    {
    ...
    public function update(Usuario $user, Curso $model): bool
    {
    ...
    public function delete(Usuario $user, Curso $model): bool
    {
