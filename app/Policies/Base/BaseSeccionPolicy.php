...
/**
 * Policy Base para Seccion - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/SeccionPolicy.php:
 ...
 */
abstract class BaseSeccionPolicy
{
    ...
    public function view(Usuario $user, Seccion $model): bool
    {
    ...
    public function update(Usuario $user, Seccion $model): bool
    {
    ...
    public function delete(Usuario $user, Seccion $model): bool
    {
