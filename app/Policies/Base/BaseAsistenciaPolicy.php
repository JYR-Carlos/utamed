...
/**
 * Policy Base para Asistencia - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/AsistenciaPolicy.php:
 ...
 */
abstract class BaseAsistenciaPolicy
{
    ...
    public function view(Usuario $user, Asistencia $model): bool
    {
    ...
    public function update(Usuario $user, Asistencia $model): bool
    {
    ...
    public function delete(Usuario $user, Asistencia $model): bool
    {
