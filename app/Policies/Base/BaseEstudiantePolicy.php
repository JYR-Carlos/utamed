...
/**
 * Policy Base para Estudiante - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/EstudiantePolicy.php:
 ...
 */
abstract class BaseEstudiantePolicy
{
    use HasBasePolicyMethods;

    protected string $resource = 'usuarios/estudiantes';
    ...
    public function view(Usuario $user, Estudiante $model): bool
    {
    ...
    public function update(Usuario $user, Estudiante $model): bool
    {
    ...
    public function delete(Usuario $user, Estudiante $model): bool
    {
