...
/**
 * Policy Base para AsignacionPlan - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/AsignacionPlanPolicy.php:
 ...
 */
abstract class BaseAsignacionPlanPolicy
{
    ...
    public function view(Usuario $user, AsignacionPlan $model): bool
    {
    ...
    public function update(Usuario $user, AsignacionPlan $model): bool
    {
    ...
    public function delete(Usuario $user, AsignacionPlan $model): bool
    {
