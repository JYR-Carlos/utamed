...
/**
 * Policy Base para Plan - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/PlanPolicy.php:
...
abstract class BasePlanPolicy
{
    ...
    public function view(Usuario $user, Plan $model): bool
    {
    ...
    public function update(Usuario $user, Plan $model): bool
    {
    ...
    public function delete(Usuario $user, Plan $model): bool
    {
