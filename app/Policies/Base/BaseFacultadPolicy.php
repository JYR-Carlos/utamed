...
/**
 * Policy Base para Facultad - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/FacultadPolicy.php:
 ...
 */
abstract class BaseFacultadPolicy
{
    use HasBasePolicyMethods;

    protected string $resource = 'facultades';
