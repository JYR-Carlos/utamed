...
/**
 * Policy Base para Departamento - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/DepartamentoPolicy.php:
 ...
 */
abstract class BaseDepartamentoPolicy
{
    ...
    public function view(Usuario $user, Departamento $model): bool
    {
    ...
    public function update(Usuario $user, Departamento $model): bool
    {
    ...
    public function delete(Usuario $user, Departamento $model): bool
    {
