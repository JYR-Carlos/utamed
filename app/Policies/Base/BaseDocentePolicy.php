...
/**
 * Policy Base para Docente - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/DocentePolicy.php:
 ...
 */
abstract class BaseDocentePolicy
{
    use HasBasePolicyMethods;

    protected string $resource = 'usuarios/docentes';
    ...
    public function view(Usuario $user, Docente $model): bool
    {
    ...
    public function update(Usuario $user, Docente $model): bool
    {
    ...
    public function delete(Usuario $user, Docente $model): bool
    {
