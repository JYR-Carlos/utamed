...
/**
 * Policy Base para Rol - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/RolPolicy.php:
...
abstract class BaseRolPolicy
{
    ...
    public function view(Usuario $user, Rol $model): bool
    {
    ...
    public function update(Usuario $user, Rol $model): bool
    {
    ...
    public function delete(Usuario $user, Rol $model): bool
    {
