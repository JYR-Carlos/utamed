...
/**
 * Policy Base para Componente - AUTOGENERADA
 * ⚠️ NO EDITAR - Se sobrescribe al regenerar
 *
 * Para personalizaciones, extender en app/Policies/ComponentePolicy.php:
 ...
 */
abstract class BaseComponentePolicy
{
    use HasBasePolicyMethods;

    protected string $resource = 'cursos/componentes';
    ...
    public function view(Usuario $user, Componente $model): bool
    {
    ...
    public function update(Usuario $user, Componente $model): bool
    {
    ...
    public function delete(Usuario $user, Componente $model): bool
    {
