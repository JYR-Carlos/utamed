...
<div class="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-6 md:p-10 text-gray-900">
    <div class="w-full max-w-sm bg-white p-8 rounded-lg shadow border border-gray-200">
        <div class="flex flex-col gap-8">
            <div class="flex flex-col items-center gap-4">
                ...
                <div class="space-y-2 text-center">
                    ...
                    <p class="text-center text-sm text-gray-500">{description}</p>
                </div>
            </div>
            {@render children?.()}
        </div>
    ...
    <div class="mt-8 text-center text-xs text-gray-400">
        &copy; 2026 Universidad de Tarapacá
    </div>
</div>
