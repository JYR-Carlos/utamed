        ...
        {#each rubrica.niveles as nivel}
          <div class="border-2 border-gray-100 rounded-3xl overflow-hidden bg-white shadow-sm">
            <div class="bg-gray-50 px-6 py-4 border-b flex justify-between items-center">
              ...
              <span class="bg-primary text-secondary px-3 py-1 rounded-full text-xs font-bold shrink-0 ml-2">
            ...
            <div class="grid grid-cols-1 divide-y divide-gray-100">
              {#each nivel.escalas as escala}
                <div class="p-5 flex flex-col gap-2">
                  <span class="text-xs font-black px-2 py-1 bg-gray-200 rounded text-gray-600 w-fit">
                    {escala.puntos} pts
                  </span>
        ...
        <table class="w-full border-collapse table-fixed">
          <thead>
            <tr class="bg-gray-50 border-b-2 border-gray-100">
              <th class="p-6 text-left text-sm font-black text-gray-500 uppercase tracking-wider w-1/4">
                Criterio de Evaluación
              </th>
              <th colspan={maxEscalas} class="p-6 text-center text-sm font-black text-gray-500 uppercase tracking-wider">
              ...
              <tr class="hover:bg-gray-50/30 transition-colors">
                <td class="p-6 align-top">
                  <div class="flex flex-col gap-1">
                    ...
                    <span class="mt-2 text-[10px] font-bold text-primary uppercase tracking-tighter">
                ...
                {#each nivel.escalas as escala}
                  <td class="p-5 align-top border-l border-gray-50">
                    <div class="flex flex-col gap-3">
                      <span class="text-[10px] font-black px-2 py-0.5 bg-primary-100 text-primary rounded-md self-start uppercase">
                        {escala.puntos} pts
                      </span>
