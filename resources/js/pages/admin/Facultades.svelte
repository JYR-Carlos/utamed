...
<AdminLayout>
  <div class="page-container">
    ...
    {#if flashSuccess}
      <div class="flash flash-success" role="alert">{flashSuccess}</div>
    {/if}
    {#if flashError}
      <div class="flash flash-error" role="alert">{flashError}</div>
    {/if}

    <DataTable data={facultades} {columns} onEdit={canEdit ? openEditModal : undefined} onDelete={canDelete ? openDeleteDialog : undefined} />
  </div>
