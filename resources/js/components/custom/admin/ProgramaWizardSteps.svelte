<script lang="ts">
  ...
  export let horas_taller: string;
  export let horas_laboratorio: string;
  export let categoria: string;
  export let curso: any;

  // Sección II: Presentación
  export let presentacion: string;

  // Sección III: Estándares
  export let estandares: string;

  // Sección IV: Competencias
  export let competencias_especificas: { titulo: string }[];
  export let competencias_genericas: { titulo: string }[];
  export let subcompetencias: { titulo: string }[];
  ...
  export let resultados_aprendizaje: { resultado: string }[];
  export let metodologia: string;
  export let evaluacion: string;

  // Sección VIII: Recursos
  export let recursos: { descripcion: string; tipo: string; ubicacion: string }[];

  // Sección IX: Aspectos Administrativos
  export let normativa_curso: string;
  export let ponderacion_optativa: string;
