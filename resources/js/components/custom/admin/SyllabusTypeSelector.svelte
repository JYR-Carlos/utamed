      ...
      <div class="p-6 space-y-4">
          ...
          >
            <div class="flex items-start gap-4">
              <div class="flex-shrink-0 mt-1">
                <div class="flex items-center justify-center h-12 w-12 rounded-lg bg-blue-100 group-hover:bg-blue-200 transition-colors">
                  <BookMarked size={24} class="text-blue-600" />
                </div>
              </div>
              <div class="flex-1">
                <h3 class="text-lg font-semibold text-slate-900 group-hover:text-blue-900">1. Edición Simplificada</h3>
                <p class="text-sm text-slate-600 mt-2 group-hover:text-slate-700">
                  Completa solo los campos básicos y esenciales del programa. Ideal para una creación rápida inicial.
                </p>
        ...
        {#if showOptions.includes('combined')}
          ...
          >
            <div class="flex items-start gap-4">
              <div class="flex-shrink-0 mt-1">
                <div class="flex items-center justify-center h-12 w-12 rounded-lg bg-amber-100 group-hover:bg-amber-200 transition-colors">
                  <BookOpen size={24} class="text-amber-600" />
                </div>
              </div>
              <div class="flex-1">
                <h3 class="text-lg font-semibold text-slate-900 group-hover:text-amber-900">
                  {existingSyllabusType === 'BASICO' ? '2. Continuar y completar' : '2. Del Simplificado al Completo'}
                </h3>
                <p class="text-sm text-slate-600 mt-2 group-hover:text-slate-700">
        ...
        {#if showOptions.includes('complete')}
          ...
          >
            <div class="flex items-start gap-4">
              <div class="flex-shrink-0 mt-1">
                <div class="flex items-center justify-center h-12 w-12 rounded-lg bg-green-100 group-hover:bg-green-200 transition-colors">
                  <BookPlus size={24} class="text-green-600" />
                </div>
              </div>
              <div class="flex-1">
                <h3 class="text-lg font-semibold text-slate-900 group-hover:text-green-900">3. Syllabus Completo</h3>
                <p class="text-sm text-slate-600 mt-2 group-hover:text-slate-700">
                  Crea el programa completo de una vez con todas las 9 secciones y detalles. Para usuarios con experiencia.
                </p>
                <ul class="text-xs text-slate-500 mt-3 space-y-1 pl-4">
