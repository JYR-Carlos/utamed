...
test('mappings se cargan correctamente del archivo', function () {
    ...
    expect($mappings['utamed.Administrativo.Carrera']['type'])->toBe('direct');
    expect($mappings['utamed.Administrativo.AsignacionPlan']['type'])->toBe('hierarchical');
    expect($mappings['utamed.Usuario.Usuario']['type'])->toBe('global');
});
