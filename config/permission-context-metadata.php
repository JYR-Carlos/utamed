...
return [
    ...
    'cursos/programas:ver_todos' => ['global', 'curso', 'carrera', 'departamento', 'facultad'],
    'cursos/programas:ver_ultimo' => ['global', 'curso', 'carrera', 'departamento', 'facultad'],
    ...
    'componentes:*' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes:ver' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes:editar' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes:crear' => ['global', 'curso'],
    'componentes:crear_plantilla' => ['global', 'curso'],
    'componentes:eliminar' => ['global', 'curso'],
    'componentes/inscripciones:*' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes/inscripciones:ver' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes/inscripciones:inscribir_alumnos' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes/inscripciones:eliminar_inscripciones' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes/asistencia:*' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes/asistencia:ver' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes/asistencia:registrar' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes/asistencia:editar' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes/asistencia:eliminar' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes/docentesColegiados:*' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes/docentesColegiados:ver' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes/docentesColegiados:agregar' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'componentes/docentesColegiados:eliminar' => ['global', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades:*' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades:ver' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades:editar' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades:subir_entregas' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades:evaluar' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades:dar_feedback' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades:enviar_recordatorios' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades:descargar_entregas' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades:crear' => ['global', 'componente'],
    'actividades:crear_plantilla' => ['global', 'componente'],
    'actividades:eliminar' => ['global', 'componente'],
    'actividades/grupos:*' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades/grupos:ver' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades/grupos:crear' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades/grupos:editar' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    'actividades/grupos:eliminar' => ['global', 'actividad', 'componente', 'curso', 'carrera', 'departamento', 'facultad'],
    '*' => ['global'],
];